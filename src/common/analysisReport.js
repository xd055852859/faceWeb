...
const analysisReport = {
  analysisReport: (report, height, width, img, canvasNameStr) => {
    ...
    let faceArr = [
      parseInt(faceOrgArr[1]),
      parseInt(faceOrgArr[2]),
    ...
    return {
      ...
      viewHeight: parseInt(personHeight * scaleNum+30),
    };
  },
};
